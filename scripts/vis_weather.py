...
ax1.text(indicatation_text_x, indicatation_text_y, 'b)', transform=ax1.transAxes, size=16, weight='bold')
...
ax2.text(indicatation_text_x, indicatation_text_y, 'a)', transform=ax2.transAxes, size=16, weight='bold')


# Second subplot
# Third subplot
ax3 = fig.add_subplot(gs[1, 1])
ax3.plot(df_IND.index, df_IND['IRRAD']/j_to_mj, label='IRRAD', color='b')
...
ax3.text(indicatation_text_x, indicatation_text_y, 'd)', transform=ax3.transAxes, size=16, weight='bold')
ax3.legend()
...
ax4.text(indicatation_text_x, indicatation_text_y, 'c)', transform=ax4.transAxes, size=16, weight='bold')
